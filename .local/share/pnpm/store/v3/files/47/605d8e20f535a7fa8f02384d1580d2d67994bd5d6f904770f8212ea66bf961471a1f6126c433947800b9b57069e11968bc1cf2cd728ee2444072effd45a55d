import { z } from "zod";
declare const schemaTransactionSignParams: z.ZodObject<{
    accountId: z.ZodString;
    rawTransaction: z.ZodDiscriminatedUnion<"family", z.Primitive, z.ZodObject<z.extendShape<{
        amount: z.ZodString;
...
declare const schemaTransactionSignResults: z.ZodObject<{
    signedTransactionHex: z.ZodString;
}, "strip", z.ZodTypeAny, {
    signedTransactionHex: string;
}, {
    signedTransactionHex: string;
}>;
export declare const schemaTransactionSign: {
    params: z.ZodObject<{
        accountId: z.ZodString;
        rawTransaction: z.ZodDiscriminatedUnion<"family", z.Primitive, z.ZodObject<z.extendShape<{
            amount: z.ZodString;
...
export declare type TransactionSign = {
    params: z.infer<typeof schemaTransactionSignParams>;
    result: z.infer<typeof schemaTransactionSignResults>;
};
export declare type TransactionSignHandler = (params: TransactionSign["params"]) => TransactionSign["result"];
export {};
//# sourceMappingURL=TransactionSign.d.ts.map