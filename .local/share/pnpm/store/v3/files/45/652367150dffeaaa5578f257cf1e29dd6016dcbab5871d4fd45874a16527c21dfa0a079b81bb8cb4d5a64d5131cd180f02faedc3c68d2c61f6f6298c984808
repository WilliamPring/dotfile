 ...
 */
export declare type Families = z.infer<typeof schemaFamilies>;
/**
 ...
 */
export declare type RawTransactionCommon = z.infer<typeof schemaRawTransaction>;
/**
 ...
 */
export declare type RawTransaction = z.infer<typeof schemaRawTransaction>;
/**
 ...
 */
export declare type Transaction = EthereumTransaction | BitcoinTransaction | AlgorandTransaction | CryptoOrgTransaction | RippleTransaction | CosmosTransaction | TezosTransaction | PolkadotTransaction | StellarTransaction | TronTransaction;
